...
//        [ret setStoreName:[dictionary objectForKey:@"storeName"]];
        [ret setStoreName:[dictionary objectForKey:@"name"]];
        [ret setStoreType:[dictionary objectForKey:@"storeType"]];
        [ret setBrandsSpecialLogic:dictionary[@"brands"][@"specialLogic"]];
        [ret setBrands:[[dictionary objectForKey:@"brands"] objectForKey:@"list"]];
