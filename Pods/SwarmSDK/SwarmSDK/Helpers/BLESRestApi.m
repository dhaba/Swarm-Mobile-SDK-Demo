...
-(void)requestActionForCampaign:(NSString*)campaignId forSwarmId:(NSString*)swarmId withRemoteId:(NSString*)remoteIdP withPartnerId:(NSString*)partnerIdP
{
    ...
    if ([self requestActionForCampaignRestHelper]== nil) {
        BLESRequestActionForCampaignRestHelper *restHelper = [[BLESRequestActionForCampaignRestHelper alloc]init];
        [self setRequestActionForCampaignRestHelper:restHelper];
        [restHelper setRestApi:self];
        [restHelper setCampaignId:campaignId];
    }
