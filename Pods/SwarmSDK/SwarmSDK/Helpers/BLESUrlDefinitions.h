...
#define urlPostReactionForCoupon @"http://api.swarm-mobile.com/my/coupon/"
//+{couponid}"
...
#define urlBaseGetCouponForCampaign @"http://api.swarm-mobile.com/coupon/campaign/"
...
#define urlWhereAmIService @"http://api.swarm-mobile.com/where_am_i"

//#define urlWhereAmIService @"http://192.168.10.100/publish"
//#define urlBaseWhatIsHereService @"http://webservices.swarm-mobile.com/latlon/services/what_is_here?userid="
#define urlBaseWhatIsHereService @"http://api.swarm-mobile.com/what_is_here?userid="

//url for swarmLogin
//#define urlPostSwarmLogin @"http://webservices.swarm-mobile.com/latlon/services/api/login"
//#define urlPostSwarmLogin @"http://webservices.swarm-mobile.com/latlon/services/api/login"
#define urlPostSwarmLogin @"http://api.swarm-mobile.com/api/login"
...
#define beaconUUID @"45FB2AE1-A73B-4ECC-852D-DB5BDFCB4F1C"
#endif
