...
//    }
    if(dict[@"NAICS Code"]) {
        SWARMNaicsCategorization *snc = [SWARMNaicsCategorization new];
        [snc setNaicsCode:dict[@"naicscode"]];
        [ret addObject:snc];
    }
    
    if(dict[@"IAB Tier 1 Category"]) {
        SWARMIabCategorization *sic = [SWARMIabCategorization new];
        [sic setIabTierOneCategory:dict[@"IAB Tier 1 Category"]];
        [sic setIabTierTwoCategory:dict[@"IAB Tier 2 Category"]];
        [ret addObject:sic];
    }
